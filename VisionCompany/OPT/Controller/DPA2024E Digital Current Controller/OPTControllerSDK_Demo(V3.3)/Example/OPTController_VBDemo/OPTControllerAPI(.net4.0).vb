...
Module OPTControllerAPI
  Public Structure OPTControllerHandleType
    ...
    Public Const OPT_ERR_RESETSEQFAILED As Integer = 3001050   'Failed to reset SEQ
    ...
    End Function
    <Runtime.InteropServices.DllImport("OPTController.dll", CallingConvention:=Runtime.InteropServices.CallingConvention.Cdecl)>
    Public Function OPTController_ReadSN(ByVal controllerHandle As OPTControllerHandleType, ByRef SN As String) As Integer
    End Function
    <Runtime.InteropServices.DllImport("OPTController.dll", CallingConvention:=Runtime.InteropServices.CallingConvention.Cdecl)>
    Public Function OPTController_ReadIPConfig(ByVal controllerHandle As OPTControllerHandleType, ByRef IP As String, ByRef subnetMask As String, ByRef defaultGateway As String) As Integer
    End Function

    <Runtime.InteropServices.DllImport("OPTController.dll", CallingConvention:=Runtime.InteropServices.CallingConvention.Cdecl)>
    Public Function OPTController_ReadProperties(ByVal controllerHandle As OPTControllerHandleType, ByVal properties As Integer, ByRef value As String) As Integer
    End Function
   ...
   <Runtime.InteropServices.DllImport("OPTController.dll", CallingConvention:=Runtime.InteropServices.CallingConvention.Cdecl)>
    Public Function OPTController_ReadMAC(ByVal controllerHandle As OPTControllerHandleType, ByRef MAC As String) As Integer
    End Function
  ...
  <Runtime.InteropServices.DllImport("OPTController.dll", CallingConvention:=Runtime.InteropServices.CallingConvention.Cdecl)>
   ...
   <Runtime.InteropServices.DllImport("OPTController.dll", CallingConvention:=Runtime.InteropServices.CallingConvention.Cdecl)>
    Public Function OPTController_GetVersion(ByRef version As String) As Integer
    End Function


   <Runtime.InteropServices.DllImport("OPTController.dll", CallingConvention:=Runtime.InteropServices.CallingConvention.Cdecl)>
    Public Function OPTController_ConnectionResetBySN(ByRef serialNumber As String) As Integer
    End Function

   <Runtime.InteropServices.DllImport("OPTController.dll", CallingConvention:=Runtime.InteropServices.CallingConvention.Cdecl)>
    Public Function OPTController_ConnectionResetByIP(ByRef serverIPAddress As String) As Integer
    End Function
   ...
   <Runtime.InteropServices.DllImport("OPTController.dll", CallingConvention:=Runtime.InteropServices.CallingConvention.Cdecl)>
    ...
    <Runtime.InteropServices.DllImport("OPTController.dll", CallingConvention:=Runtime.InteropServices.CallingConvention.Cdecl)>
    Public Function OPTController_GetControllerListOnEthernet(ByRef snList As String) As Integer
    End Function
  ...
  <Runtime.InteropServices.DllImport("OPTController.dll", CallingConvention:=Runtime.InteropServices.CallingConvention.Cdecl)>
   ...
   <Runtime.InteropServices.DllImport("OPTController.dll", CallingConvention:=Runtime.InteropServices.CallingConvention.Cdecl)>
    Public Function OPTController_ReadOutputBoardVision(ByVal controllerHandle As OPTControllerHandleType, ByRef vision As String) As Integer
    End Function
   ...
   <Runtime.InteropServices.DllImport("OPTController.dll", CallingConvention:=Runtime.InteropServices.CallingConvention.Cdecl)>
    ...
    End Function
     ...
     <Runtime.InteropServices.DllImport("OPTController.dll", CallingConvention:=Runtime.InteropServices.CallingConvention.Cdecl)>
    Public Function OPTController_SetIPConfiguration(ByVal controllerHandle As OPTControllerHandleType, ByRef IP As String, ByRef subnetMask As String, ByRef defaultGateway As String) As Integer
    End Function

     <Runtime.InteropServices.DllImport("OPTController.dll", CallingConvention:=Runtime.InteropServices.CallingConvention.Cdecl)>
    Public Function OPTController_SetOutputVoltage(ByVal controllerHandle As OPTControllerHandleType, ByVal channelIndex As Integer, ByVal voltage As Integer) As Integer
    End Function

     <Runtime.InteropServices.DllImport("OPTController.dll", CallingConvention:=Runtime.InteropServices.CallingConvention.Cdecl)>
    Public Function OPTController_ReadOutputVoltage(ByVal controllerHandle As OPTControllerHandleType, ByVal channelIndex As Integer, ByRef voltage As Integer) As Integer
    End Function
     <Runtime.InteropServices.DllImport("OPTController.dll", CallingConvention:=Runtime.InteropServices.CallingConvention.Cdecl)>
    Public Function OPTController_SetTimeUnit(ByVal controllerHandle As OPTControllerHandleType, ByVal channelIndex As Integer, ByVal timeUnit As Integer) As Integer
    End Function

     <Runtime.InteropServices.DllImport("OPTController.dll", CallingConvention:=Runtime.InteropServices.CallingConvention.Cdecl)>
    Public Function OPTController_ReadTimeUnit(ByVal controllerHandle As OPTControllerHandleType, ByVal channelIndex As Integer, ByRef timeUnit As Integer) As Integer
    End Function
End Module
